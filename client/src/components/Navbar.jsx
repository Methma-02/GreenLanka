...
const Navbar = () => {
    ...
    const { user, setUser, setShowUserLogin, navigate } = useAppContext(); // Fixed function name
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {!user ? (
                    ...
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border boarder-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
